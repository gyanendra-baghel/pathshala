...
const TeacherClassroom: React.FC = () => {
  const { classes, classWork } = useAppContext();
  ...
  const teacherClasses = getTeacherClasses("1"); // Mock teacher ID
  return (
    <div className="space-y-6">
          ...
          >
            ...
            <div className="px-6 py-4 bg-gray-50 border-t">
              <div className="flex gap-4">
                <Link to={`/teacher/classes/${class_.id}`}>
      ...
      {teacherClasses.map((class_) => (
        <div key={class_.id} className="mt-8 space-y-4">
          <div className="flex justify-between items-center">
            <h3 className="text-xl font-semibold">{class_.name} - Classwork</h3>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            {getClassWork(class_.id).map((work) => (
